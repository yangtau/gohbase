...
type Procedure struct {
	...
	StateMessage []*anypb.Any             `protobuf:"bytes,15,rep,name=state_message,json=stateMessage" json:"state_message,omitempty"` // opaque (user) procedure internal-state
...
func (x *Procedure) GetStateMessage() []*anypb.Any {
	if x != nil {
